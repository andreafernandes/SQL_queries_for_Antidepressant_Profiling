...
/****** Object:  View [dbo].[AFernandes_Antidepressant_Distinct_Snapshot_Mar15_Aug15]    Script Date: 07/21/2016 18:01:09 ******/
SET ANSI_NULLS ON
GO
...
-- Second Table to Run after
-- dbo.AFernandes_Antidepressants_MultiRowPerPatient_Snapshot_MAR2015_AUG2015
-- This view selects just the BRCIDs from the multi row per patient table. 
-- It identifies the distinct individual patients who are on antidepressant
-- during the observation and is a distinct list of their IDs



ALTER VIEW [dbo].[AFernandes_Antidepressant_Distinct_Snapshot_Mar15_Aug15] AS
				...
				(					 select   *
											,ROW_NUMBER() OVER (PARTITION BY brcid,
													...
													CASE 
													      ...
													      --REMOVED THIS ON ROB AND RINA'S ADVICE AFTER SUPERVISION 15122015 
													...
													--most recent earliest AD medication mention
